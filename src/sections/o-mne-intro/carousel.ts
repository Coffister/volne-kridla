...
export const oMneCarouselImages: CarouselImage[] = [
  ...
  { id: "o-mne-2", src: slide2, alt: "Franka s korelkami v prírode" },
  { id: "o-mne-3", src: slide3, alt: "Franka s papagájmi počas začiatkov" },
  { id: "o-mne-4", src: slide4, alt: "Franka so žakom a arami" },
  { id: "o-mne-5", src: slide5, alt: "Papagáje pri voľnom lietaní v záhrade" },
  { id: "o-mne-6", src: slide6, alt: "Dvojica ár na stojane v poli" },
  { id: "o-mne-7", src: slide7, alt: "Ara ararauna a amazoňan v prírode" },
];
